...
class HealthFragmentViewModel @Inject constructor(private val fireStore: FirebaseFirestore, private val firebaseRepository: FirebaseRepository, private val auth: FirebaseAuth) : ScopedViewModel() {
                ...
                if (auth.currentUser == null)
                    auth.signInAnonymously()
                            .addOnSuccessListener { authResult ->
                                ...
                                articles = FirebaseQueryLiveData(firebaseRepository.applyFilters(fireStore.articles(), Articles().apply { category = Config.CATEGORY_HEALTH }, lastVisible))
