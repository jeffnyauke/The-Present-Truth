...
import com.example.jeffreynyauke.myapplication.utils.WebUtils;
...
public class BrowserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordinatorLayout = ButterKnife.findById(this, R.id.main_content);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (WebUtils.isBookmarked(this, webView.getUrl())) {
            // change icon color
            WebUtils.tintMenuIcon(getApplicationContext(), menu.getItem(0), R.color.colorAccent);
        } else {
            WebUtils.tintMenuIcon(getApplicationContext(), menu.getItem(0), android.R.color.white);
        }
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_bookmark) {
            ...
            WebUtils.bookmarkUrl(this, webView.getUrl());

            String msg = WebUtils.isBookmarked(this, webView.getUrl()) ?
