...
public class Post_NewsProvider extends ItemViewProvider<Post_News, Post_NewsProvider.TextHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull TextHolder holder, @NonNull Post_News postNews) {
