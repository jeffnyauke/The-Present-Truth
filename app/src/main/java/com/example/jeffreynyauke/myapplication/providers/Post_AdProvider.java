...
public class Post_AdProvider extends ItemViewProvider<Post_Ad, Post_AdProvider.TextHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull TextHolder holder, @NonNull Post_Ad postNews) {
