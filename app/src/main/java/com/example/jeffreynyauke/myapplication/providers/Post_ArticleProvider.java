...
public class Post_ArticleProvider extends ItemViewProvider<Post_Article, Post_ArticleProvider.TextHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull TextHolder holder, @NonNull Post_Article postNews) {
